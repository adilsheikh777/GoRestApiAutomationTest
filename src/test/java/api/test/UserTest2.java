...
public class UserTest2 {
	...
	public  void createUser(ITestContext context)
	{
	    ...
	    Response response = UserEndPointsUsingProperties.postUser(payload);
	...
	public void ViewUser(ITestContext context)
	{
		...
		Response response = UserEndPointsUsingProperties.getUser(id);
	...
	public void updatingUser(ITestContext context)
	{
		...
		Response response = UserEndPointsUsingProperties.updateUser(id, payload);
	...
	public void deletingUser(ITestContext context)
	{
		...
		Response response = UserEndPointsUsingProperties.deleteUser(id);
	...
	public void getAllUsers(ITestContext context)
	{
		...
		Response response = UserEndPointsUsingProperties.viewAllUser();
